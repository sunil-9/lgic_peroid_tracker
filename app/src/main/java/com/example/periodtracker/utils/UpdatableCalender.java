...
public class UpdatableCalender{}
//
//public class UpdatableCalender extends LinearLayoutCompat implements ResProvider {
//
//    @ColorRes
...
//
//
//    public UpdatableCalender(Context context) {
//        super(context);
//        init(context);
//    }
//
//    public UpdatableCalender(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        initStyle(context, attrs);
//        init(context);
//    }
//
//    public UpdatableCalender(Context context, AttributeSet attrs, int defStyleAttr) {
